        ...
        <table id="datatable" class="table">
            <thead>
                ...
                <tr>					
                    ...
                    <td>
                        <div class="d-flex">
                            <a href="{{route('categories.edit',['category'=>$a->slug])}}"><button class="btn-sm btn-secondary" data-toggle="tooltip" title='Edit Product'>Edit</button></a>
                            <form action="{{route('categories.destroy',['category'=>$a->slug])}}" method="POST">
                               @csrf
                               @method('delete')
